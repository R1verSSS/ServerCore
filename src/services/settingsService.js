...
const DEFAULT_SETTINGS = {
  ...
  complaintsChannelName: process.env.COMPLAINTS_CHANNEL_NAME || '🚨・жалобы',
  complaintsChannelId: process.env.COMPLAINTS_CHANNEL_ID || '1512791244965806170',
  ticketActiveCategoryName: process.env.TICKET_ACTIVE_CATEGORY_NAME || '🎫 АКТИВНЫЕ ТИКЕТЫ',
