...
## v24.1 Admin Operations Upgrade

Добавлены инструменты эксплуатации на хостинге:

- `/update-check` — проверка обновления и регистрации команд.
- `/update-center` — центр обновлений в веб-панели.
- `/changelog` — журнал изменений.
- `/errors` — просмотр последних ошибок.
- `/scenarios` — админ-сценарии: backup перед обновлением, stable backup, post-update check.

После обновления, если менялись команды, выполните:
